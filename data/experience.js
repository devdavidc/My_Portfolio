export const ExperienceDataEs = [
      ...
      {
        "title": "2021 - 2023 Administración y Finanzas",
        "content": [
          "Estudios realizados en el IES El Calero, centrados en gestión financiera, principios contables y operaciones empresariales.",
          "Desarrollé habilidades clave en análisis financiero, presupuestación y planificación estratégica, que me ayudan a entender y afrontar retos reales del entorno empresarial."
        ]
      }
    ]
    ...
    {
      "title": "2021 - 2023 Business Administration and Finance",
      "content": [
        "Studied at IES El Calero, focusing on financial management, accounting principles, and business operations.",
        "Developed key skills in financial analysis, budgeting, and strategic planning, which help me understand and tackle real-world business challenges."
      ]
    }
  ]